...
int main ( int argc, char** argv )
{
    ...
    Eigen::Quaterniond q3 (2, 0, 1, -3); 

    cout << "This quaternion consists of a scalar " << q3.w() << " and a vector " << endl << q3.vec() << endl;



    q3.normalize();

    cout << "To represent rotation, we need to normalize it such that its length is " << q3.norm() << endl;
